...
<main>
    ...
    <div class="p-10 flex flex-col items-center gap-8">
        ...
        <div class="flex flex-row justify-center gap-8">
            {#each { length: 3 } as _, i}
                <div
                    class="card bg-base-100 w-96 shadow-xl flex flex-row justify-center p-6 gap-4"
                >
                    <div class="flex flex-col gap-2 me-8">
                        <svg
                            ...
                            /></svg
                        >
                        <p class="text-2xl">Flight name</p>
                        <p>Flight Date</p>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <p>Flight Duration</p>
                        <p>Stop Info</p>
                        <p class="text-3xl">Flight Price</p>
    ...
    <div class="p-10 flex flex-col items-center gap-8">
        ...
        <div class="flex flex-row justify-center gap-8">
            {#each { length: 3 } as _, i}
                <div
                    class="card bg-base-100 w-96 shadow-xl flex flex-col justify-center items-center p-6 gap-2"
                >
